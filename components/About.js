    ...
    <section id="about" className="relative bg-gradient-to-b from-black via-neutral-900 to-black text-white scroll-mt-20 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-8 py-24 md:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="flex justify-center md:justify-start">
            <div className="relative w-64 md:w-[400px] lg:w-[500px]">
      ...
      <div className="relative max-w-6xl mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          {devs.map((d) => (
            <article key={d.id} className="relative rounded-xl p-4 overflow-hidden bg-gradient-to-b from-white/6 via-white/4 to-black/30 shadow-2xl border border-white/20">
              ...
              <div className="relative z-10">
                ...
                <div className="h-72 flex items-end justify-center">
                  <img src={d.img} alt={d.name} className="object-contain h-64 relative z-50" />
                </div>
              </div>

              {/* stronger bottom overlay so the card reads like the design */}
              <div className="absolute inset-x-0 bottom-0 h-56 bg-gradient-to-t from-black/90 to-transparent pointer-events-none z-30" />
            </article>
          ))}
        </div>
      </div>
